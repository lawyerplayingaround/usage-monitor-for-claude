...
>
> That repository builds the Windows portable EXE and the macOS app from a single source tree, based on upstream v1.20.0 (this repository stopped at 1.15.1). Existing releases here remain downloadable.
